        ...
        <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="auto">
            ...
            <el-form-item prop="code">
                <div class="code-inputs">
                    <el-input v-for="(_, index) in 4" :key="index" v-model="ruleForm.code[index]"
                        @input="handleCodeInput(index, $event)" @keydown.delete="handleCodeDelete(index, $event)"
                        maxlength="1" class="code-item" />
                    <el-button type="primary" @click="handleCode" :disabled="countdown > 0"
